        ...
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ \App\User::where('role_id', 1)->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    <div class="card-header"><h4>Total Member</h4></div>
                    <div class="card-body">{{ \App\User::where('role_id', 2)->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ \App\Book::count() }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ \App\Peminjaman::count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ \App\Pengembalian::count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ \App\Rak::count() }}</div>
                </div>
            </div>
        </div>
    </div>
