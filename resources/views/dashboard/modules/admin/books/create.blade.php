...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.admin.books.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                data-style="form-control" data-width="100%">
                                    @foreach ($raks as $rak)
                                        <option {{ old('rak_id') === $rak->id ? 'selected' : '' }} value="{{ $rak->id }}">{{ $rak->name }}</option>
                                    @endforeach
                            </select>
                            @error('rak_id')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                name="description"
                                class="form-control" style="min-height: 100px">{{ old('description') }}</textarea>
                        </div>
