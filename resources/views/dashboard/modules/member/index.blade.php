        ...
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ Auth::user()->member_peminjamans()->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">{{ Auth::user()->member_pengembalians()->count() }}</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    <div class="card-header"><h4>Total Buku Masih Dipinjam</h4></div>
                    <div class="card-body">{{ Auth::user()->member_peminjamans()->count() - Auth::user()->member_pengembalians()->count() }}</div>
                </div>
            </div>
        </div>
    </div>
