...
<div class="page-wrapper bg-white bg-gra-01 p-t-130 p-b-100 font-poppins">
    <div class="wrapper wrapper--w680">
        <div class="card card-4">
            <div class="card-body">
                <h2 class="title">Edit Ceritamu</h2>
                ...
                <form method="POST" action="{{ route('articles.update', $article->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-space">
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="title" value="{{ $article->title }}">
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        <div class="col">
                            <div class="input-group">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="author" value="{{ $article->author }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        <div class="col">
                            ...
                            <textarea name="content" class="input--style-4 border-0" id="" rows="3">{{ $article->content }}</textarea>
                        </div>
                    </div>
                    <div class="p-t-15">
