            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 mb-6">
                    ...
                    <div class="row mb-3 mt-5">
                        <div class="col-sm-3 col-md-2"><h6 class="font-weight-light">Super Admin</h6></div>
                        <div class="col pl-sm-5">
                            <h6 class="font-weight-bold">fsyah@gmail.com</h6>
                            <h6 class="font-weight-bold">123</h6>
                            <div>ANGGOTA(CRUD), BUKU(CRUD), PEMINJAMAN(CRUD), PENGEMBALIAN(RD), RAK(CRUD), PROFILE(RU)</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3 col-md-2"><h6 class="font-weight-light">Admin Test</h6></div>
                        <div class="col pl-sm-5">
                            <h6 class="font-weight-bold">admintest@gmail.com</h6>
                            <h6 class="font-weight-bold">123</h6>
                            <div>BUKU(CRUD), PEMINJAMAN(CRUD), PENGEMBALIAN(RD), PROFILE(R)</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3 col-md-2"><h6 class="font-weight-light">Member Test</h6></div>
                        <div class="col pl-sm-5">
                            <h6 class="font-weight-bold">membertest@gmail.com</h6>
                            <h6 class="font-weight-bold">123</h6>
                            <div>BUKU(R), PROFILE(R), PEMINJAMAN(R)</div>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-sm-3 col-md-2"><h6 class="font-weight-light">Member</h6></div>
                        <div class="col pl-sm-5">
                            <h6 class="font-weight-bold">Silahkan Registrasi</h6>
                            <div>BUKU(R), PROFILE(RU), PEMINJAMAN(R)</div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            ...
                            <img src="{{ asset('img/frontpage/docs-1.PNG') }}" alt="" class="img-fluid mb-5">
